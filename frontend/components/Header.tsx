...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    ...
    >
      <nav className="bg-white/60 backdrop-blur-md rounded-[80px] shadow-lg border border-white/30">
        <div className="relative flex items-center justify-between h-16 md:h-20 px-6 md:px-8">
          <div className="flex-shrink-0">
            <a href="/" className="text-2xl md:text-3xl font-bold text-primary-600">
              Karta Jati
            </a>
          </div>
          ...
          <div className="hidden md:flex md:absolute md:left-1/2 md:transform md:-translate-x-1/2 md:space-x-8">
            ...
            <a href="#portfolio" className="text-gray-700 hover:text-primary-600 transition-colors font-medium">
              Showcase
            </a>
          </div>
